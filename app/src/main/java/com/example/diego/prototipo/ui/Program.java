...
import com.example.diego.prototipo.app.Mapa;
...
public class Program extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  toolbar.bringToFront();
        ...
        //Log.d("V","Busca por: " + it.getStringExtra("email") );
        user = new BD(this).getUsuario(it.getStringExtra("email"));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        nome = (TextView) findViewById(R.id.nome_nav);
        email = (TextView) findViewById(R.id.email_nav);
